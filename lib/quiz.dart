...
Map difficulty = {0: true, 1: false, 2: false};
int dateCount = 5;
                ...
                children: [
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                units.keys
                                    .where((element) => units[element] == true)
                                    .join('\n'),
                                  ...
                                  children:
                                    ...
                                    return ListTile(
                                      ...
                                      onTap: () {
                                        ...
                                        setState(() {
                                          units[units.keys.elementAt(index)] =
                                              !units.values.elementAt(index);
                                        });
                                      },
                                    );
                                  }),
                  ...
                  Expanded(
                    child: InkWell(
                      ...
                      onTap: () {
                        setState(() {
                          dateCount = dateCount < 20 ? dateCount + 5 : 5;
                        });
                      },
                    ),
                  ),
                ...
                onTap: () {
                  ...
                  Future.delayed(const Duration(milliseconds: 150)).then(
                      (value) => Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const QuizNavigator())));
                },
              ),
            ),
          ],
                  ...
                  child: InkWell(
                    ...
                    child: Ink(
                      ...
                      child: Container(
                        height: 70,
                        padding:
                            const EdgeInsets.only(left: 60, right: 20, top: 6),
                        ...
                        child: AutoSizeText(
                          ...
                          style: Theme.of(context)
                              .textTheme
                              .headlineSmall!
                              .copyWith(color: option['textColor']),
                          maxLines: 1,
                        ),
                      ),
                    ),
                  ...
                  Future.delayed(const Duration(milliseconds: 600), () {
                    Navigator.of(context, rootNavigator: true).pushReplacement(
                      PageRouteBuilder(
                        ...
                        transitionsBuilder: (_, animation, secondaryAnimation,
                                child) =>
                            FadeThroughTransition(
                                animation: animation,
                                secondaryAnimation: secondaryAnimation,
...
class _QuizNavigatorState extends State<QuizNavigator> {
  ...
  void prepareData() {
    units.forEach((key, value) {
      if (value) {
        List keys = hisgeoMap["التواريخ"][key].keys.toList();
        keys.shuffle();
        for (int i = 0; i < dateCount + 4 ~/ unitCount(); i++) {
          dates.add("${keys[i]}:${hisgeoMap['التواريخ'][key][keys[i]]}");
        }
      }
    });
    dates.shuffle();
                  ...
                  return Row(
                      ...
                      children: List.generate(progressList.length, (index) {
                        ...
                        var color = Theme.of(context)
                            .colorScheme
                            .secondaryContainer; //Colors.grey[200]!.withOpacity(0.8);
                        switch (progress) {
                          case 1:
                            color = Colors.green;
                          case -1:
